...
local function get_cotton_path(cotton_tag_name)
  ...
  if found_path ~= "" then return found_path end
...
local function go_to_cotton_definition()
  ...
  if not cotton_tag_name then return end
...
return {
  ...
  --     if method == methods.textDocument_definition and go_to_cotton_definition() then return end
